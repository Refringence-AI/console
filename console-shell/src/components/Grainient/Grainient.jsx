...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL2 unavailable or the context limit was reached (e.g. repeated
      // mount/unmount across persona flips). The CSS gradient rendered under
      // this canvas is the graceful fallback; just skip the WebGL layer.
      return;
    }
    ...
    return () => {
      ...
      // Free the GL context so repeated mount/unmount (persona flips) does not
      // exhaust the browser's ~16 live-WebGL-context limit and start throwing.
