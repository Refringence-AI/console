        ...
        <div className="flex h-full min-h-0 flex-col" data-testid="workboard-newbie">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-8">
                <div className="mx-auto flex w-full max-w-[1080px] flex-col gap-6">
                    ...
                    {issues.isSuccess && !hasIssues && (
                        <Card className="flex flex-col items-center gap-3 p-10 text-center" data-testid="workboard-newbie-empty">
                            <KanbanSquare className="h-7 w-7 text-muted-foreground/50" />
                            <h2 className="text-section text-foreground">Nothing to triage right now</h2>
                            <p className="max-w-md text-body leading-relaxed text-muted-foreground">
                                This board shows GitHub issues, and yours has none open. That is completely
                                fine - plenty of teams plan their work in pull requests instead of filing issues.
                            </p>
                        </Card>
                    )}
