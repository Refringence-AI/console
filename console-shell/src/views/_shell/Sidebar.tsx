...
export const GROUPS: NavGroup[] = [
    {
        ...
        items: [
            ...
            { to: '/devtools',     label: 'Tool config',  icon: Wrench,          description: 'Your AI coding tools rules, permissions, and MCP, read in one place' },
            { to: '/design',       label: 'Design system', icon: Palette,        description: 'Palette, type scale, tokens, and component libraries' },
...
const GUIDED_MORE: NavItem[] = [
    ...
    { to: '/devtools', label: 'Tool config',  icon: Wrench,     description: 'What your AI coding tools are told to do' },
    { to: '/design',   label: 'Design system', icon: Palette,   description: 'Your colours, fonts, and spacing' },
];
...
const NAV_TESTID: Record<string, string> = {
    '/overview': 'overview', '/prompts': 'prompts', '/devtools': 'devtools', '/design': 'design', '/issues': 'workboard', '/repo': 'repo',
