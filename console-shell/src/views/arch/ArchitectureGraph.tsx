...
export function ArchitectureGraph({ root, mode }: ArchitectureGraphProps) {
    ...
    // Non-JS/TS extraction is opt-in too: a big repo of independent language
    // wrappers renders as a wall of boxes, so the default stays JS/TS-only.
    // Guided mode keeps it off so the newbie map stays clean.
